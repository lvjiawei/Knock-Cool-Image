    ...
    public function connect_mysql()
    {
     ...
     if($num==0){
        echo("<table width='100%' align=center><tr><td align=center>
              Sorry<br>
              <font color=red>There is no the account!</font><br><a href='../index.html'>login again on click</a>
              </td></tr></table>
			  <script language=\"JavaScript\">window.setTimeout(\"window.location.href=\'../index.html\'\", 2*1000); </script>
			  ");              
     }
     else{
        ...
        if($row['password']==$this->password)//$_POST['pw'])
        {
           ...
           session_start();
            ...
            echo "<table width='100%' align=center><tr><td align=center>      		              
                 ...
                 <font color=greeen><a href='../user.html'>jump after a few time</a></font>
                 </td></tr></table>
                 <script language=\"JavaScript\">window.setTimeout(\"window.location.href=\'../user.html\'\", 3*1000); </script>";
            //echo("<table width='100%' align=center><tr><td align=center>            
           //   Welcome to Cool Image!<br>
           ...
           //   </td></tr></table>");
            ...
            echo("<table width='100%' align=center><tr><td align=center>
            Sorry<br>  
            <font color=red>Wrong password!</font><br><a href='../index.html'>login again on click</a>
            </td></tr></table>
			<script language=\"JavaScript\">window.setTimeout(\"window.location.href=\'../index.html\'\", 2*1000); </script>
			");
        }
